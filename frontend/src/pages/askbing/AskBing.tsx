...
import styles from "./AskBing.module.css";

import { askBing, CustomApproaches, AskBingResponse, AskBingRequest } from "../../api";
...
const AskBing = () => {
    ...
    const [approach, setApproach] = useState<CustomApproaches>(CustomApproaches.BingSearch);
    ...
    const [answer, setAnswer] = useState<AskBingResponse>();
    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            const result = await askBing(request);
            setAnswer(result);
        } catch (e) {
            setError(e);
        } finally {
    ...
    const onApproachChange = (_ev?: React.FormEvent<HTMLElement | HTMLInputElement>, option?: IChoiceGroupOption) => {
        setApproach((option?.key as CustomApproaches) || CustomApproaches.BingSearch);
    };
    ...
    const approaches: IChoiceGroupOption[] = [
        {
            key: CustomApproaches.BingSearch,
    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>Ask Bing</h1>
